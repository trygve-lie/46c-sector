...
// http://localhost:9100/arm/partial?key=<key>
...
// http://localhost:9100/arm/total?key=<key>
...
app.listen(config.get('httpServerPort'), config.get('httpServerHost'), (error) => {
